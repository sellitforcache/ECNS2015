...
The geometry of the best-performing case is shown in figure \ref{case077}.  The depth is 10 cm, the opening width is 12 cm, and the slope is 0.5.  This opening is as wide as the nozzle and almost tapers to a point at the maximum depth.  The maximum depth is 4 cm from the cold source geometrical center.
...
Flux reconstruction method verified  to be at least self-consistent
Near optimal X-Y REH geometry has been determined
REH increases total exit current by 1.25\% on average from 3-6 \AA{} with a peak gain of 1.32 at 5.5 \AA{}.
